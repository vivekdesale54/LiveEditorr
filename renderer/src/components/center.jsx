...
export default function Center() {
  return (
    <div className="w-[380px] flex flex-col items-center justify-center bg-gray-50 border-r">
      ...
      <div className="flex gap-2 mt-6">
        <button className="px-4 py-2 bg-gray-200 rounded text-sm">Import Project</button>
