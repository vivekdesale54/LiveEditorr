...
export default function Preview() {
  return (
    <div className="flex-1 bg-white p-6 mt-[10%]">
      <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white text-lg font-semibold px-4 py-2 rounded-t justify-center align text-center h-16 flex items-center">
        Welcome to CodeFlow
      </div>
      <div className="border rounded-b p-6 flex flex-col items-center justify-center">
